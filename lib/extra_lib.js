...
//subtract-duration! time1 time-duration -> time
  ...
  // srif-28 (basic format string)
  //
  // Taken from http://srfi.schemers.org/srfi-28/srfi-28.html
  //
  // TODO:
  //      - error
  //
  define_scmfunc("format", 1, null, 
  "(lambda (format-string . objects) \
     (let ((error (lambda (a b) (display b (current-error-port)))) \
